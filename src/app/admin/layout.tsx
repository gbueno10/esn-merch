...
export default async function AdminLayout({
  ...
  // No user — middleware handles redirect to /admin/login,
  // but if we're ON the login page, just render it bare
  if (!user) {
    return <>{children}</>;
  }

  // Check if user is project admin for merch
